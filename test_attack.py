...
from modules.utils.constants import MODEL_TRANSFORMS, DEFAULT_TEMPLATES, RSNA_CLASS_PROMPTS, RSNA_CLASS_PROMPTS, SIZE_TRANSFORM
...
import torch
import json
from modules.attack.attack import RandomSearchAttack, ES_1_1, ES_1_Lambda, ES_Mu_Lambda
...
norm = 'l2'
mode = "post_transform"
size_transform = SIZE_TRANSFORM[model_type]
...
with torch.no_grad():
    for i in range(len(dataset)):
        ...
        if mode == "post_transform":
            img_attack = size_transform(img)
        elif mode == "pre_transform":
