...
class RSNADataset(BaseClassificationDataset):
    ...
    def _load_data(self) -> pd.DataFrame:
        ...
        rsna_data_path = os.path.join(self.data_root, 'rsna_data')
        
        if not os.path.exists(rsna_data_path):
            os.makedirs(rsna_data_path, exist_ok=True)
...
class RSNAZeroShotCollator(BaseCollator):
    ...
    def _process_class_prompts(self) -> Dict[str, Any]:
        ...
        from utils import generate_rsna_class_prompts
